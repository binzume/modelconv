...
func TestEulerYXZ(t *testing.T) {
	const eps = 0.000001

	e1 := NewEuler(10*math.Pi/180, 20*math.Pi/180, 30*math.Pi/180, RotationOrderYXZ)
	e2 := NewEulerFromQuaternion(e1.ToQuaternion(), RotationOrderYXZ)
...
func TestEulerZYX(t *testing.T) {
	const eps = 0.000001

	e1 := NewEuler(10*math.Pi/180, 20*math.Pi/180, 30*math.Pi/180, RotationOrderZYX)
	e2 := NewEulerFromQuaternion(e1.ToQuaternion(), RotationOrderZYX)
